...
import framwork.easy.android.db.sqlite.CursorUtils;
import framwork.easy.android.db.sqlite.DbModelSelector;
import framwork.easy.android.db.sqlite.Selector;
import framwork.easy.android.db.sqlite.SqlInfo;
import framwork.easy.android.db.sqlite.SqlInfoBuilder;
import framwork.easy.android.db.sqlite.WhereBuilder;
import framwork.easy.android.db.table.DbModel;
import framwork.easy.android.db.table.Id;
import framwork.easy.android.db.table.Table;
import framwork.easy.android.db.table.TableUtils;
import framwork.easy.android.exception.DbException;
import framwork.easy.android.utils.IOUtils;
...
public class DbUtils {
	...
	public static DbUtils create(Context context, String dbName, int dbVersion,
			...
			for (Object entity : entities) {
				if (!saveBindingIdWithoutTransaction(entity)) {
					throw new DbException(
							"saveBindingId error, transaction will not commit!");
				}
			}
